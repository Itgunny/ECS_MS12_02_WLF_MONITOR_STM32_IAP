...
void WRITE_RTC(struct DATA_RTC RTC_Data)
{    
...
void READ_RTC(struct DATA_RTC *RTC_Data)
{    
...
void ReadAllData(struct DATA_EEPROM *ReadData)
{
	uint8_t  i;
	uint8_t  *buf;
	uint16_t size;

	size = sizeof(struct DATA_EEPROM); 
...
void SaveAllData(struct DATA_EEPROM SaveData)
{
	uint8_t  i;
	uint8_t  *buf;
	uint16_t size;
